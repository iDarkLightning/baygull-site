...
> = (props) => (
  <AriaMenuItem
    className={({ isSelected, isDisabled, isFocused, isHovered }) =>
      cn(
        "mx-1.5 my-1 flex text-start cursor-default flex-col rounded-md px-4 py-1.5 text-sm text-neutral-700 font-medium outline-none transition-[background-color]",
        {
